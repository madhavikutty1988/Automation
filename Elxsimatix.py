...
username=String_Decrypt.usrnm_use
password=String_Decrypt.pswd_use

driver.find_element_by_name("portlet_2_1{actionForm.username}").send_keys(username)
driver.find_element_by_name("portlet_2_1{actionForm.password}").send_keys(password)
...
driver.find_element_by_xpath("/html/body/div/div[2]/div[2]/span/div/table/tbody/tr/td[1]/div/table/tbody/tr[1]/td/div/div/div[2]/table/tbody/tr/td/ul/li[31]/a").click()
